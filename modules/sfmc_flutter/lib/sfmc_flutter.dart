...
class SFMCSDK {
  ...
  static Future<bool?> setupSFMC({
    ...
    required String mid,
    required String sfmcURL,
    required String senderId,
    required bool delayRegistration,
  }) async {
  ...
  static Future<bool?> setDeviceToken(String deviceToken) async {
    final bool? result = await _channel.invokeMethod('setDeviceToken', {"deviceKey": deviceToken});
    return result;
  }
  ...
  static Future<bool?> setContactKey(String contactKey) async {
    final bool? result = await _channel.invokeMethod('setContactKey', {"cId": contactKey});
    return result;
  }
  ...
  */
  static Future<bool?> setAttribute(String attrName, String attrValue) async {
    final bool? result = await _channel.invokeMethod('setAttribute', {"name": attrName, "value": attrValue});
    return result;
  }

  static Future<bool?> clearAttribute(String attrName) async {
    final bool? result = await _channel.invokeMethod('clearAttribute', {"name": attrName});
    return result;
  }
  ...
  */
  static Future<bool?> setTag(String tagName) async {
    final bool? result = await _channel.invokeMethod('setTag', {"tag": tagName});
    return result;
  }

  static Future<bool?> removeTag(String tagName) async {
    final bool? result = await _channel.invokeMethod('removeTag', {"tag": tagName});
    return result;
  }
